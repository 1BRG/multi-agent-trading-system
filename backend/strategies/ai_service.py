...
You will receive signals from our AI Stock Rater containing: {ticker, action (BUY/HOLD/SELL), conviction (0.0-1.0)}.

You MUST output ONLY valid JSON matching this exact schema. Do not include markdown formatting, code blocks (like ```json), or any explanations outside the JSON.
...
SCHEMA:
{
  ...
  "config": {
    ...
    "sector_cap_pct": 20,             // MUST be an integer between 1 and 100
